...
private fun ProfileContent(food: Food, containerHeight: Dp) {
    Column {
        ...
        ProfileProperty(stringResource(R.string.type), food.type)

        ProfileProperty(stringResource(R.string.ingredients), food.ingredients.toString())

        ProfileProperty(stringResource(R.string.cooking), food.description)
...
@Composable
fun FindFab(extended: Boolean, modifier: Modifier = Modifier) {
        ...
        AnimatingFabContent(
            icon = {
                Icon(
                    ...
                    contentDescription = stringResource(R.string.findout_more)
                )
            },
            text = {
                Text(
                    text = stringResource(R.string.findout_more),
                )
            },
            extended = extended
